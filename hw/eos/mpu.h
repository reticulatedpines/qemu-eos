...
enum button_codes
{
    ...
    BGMT_TRASH, BGMT_UNLOCK, BGMT_PICSTYLE, BGMT_LIGHT, BGMT_RATE,
    ...
    GMT_GUICMD_OPEN_SLOT_COVER, GMT_GUICMD_CLOSE_SLOT_COVER,
    GMT_GUICMD_OPEN_BATT_COVER, GMT_GUICMD_CLOSE_BATT_COVER,
    GMT_GUICMD_START_AS_CHECK, GMT_GUICMD_LOCK_ON,
